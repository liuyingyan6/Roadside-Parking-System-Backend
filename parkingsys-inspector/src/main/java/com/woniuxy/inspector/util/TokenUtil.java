package com.woniuxy.inspector.util;
...
public class TokenUtil {
    ...
    public static String createAccessToken(Integer accessTime, Inspector inspector, String signature, HttpServletRequest request){
        //产生AccessToken(小/短令牌) ,RefreshToken(大/长令牌)
        Map<String,Object> payload = new HashMap<>();
        payload.put("exp", LocalDateTime.now().plusMinutes(accessTime).
                format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
        payload.put("userId", inspector.getId());
        //获得登录者的IP地址
    ...
    public static String createRefreshToken(Integer refreshTime, Inspector inspector,String signature,HttpServletRequest request){
        //产生AccessToken(小/短令牌) ,RefreshToken(大/长令牌)
        Map<String,Object> payload = new HashMap<>();
